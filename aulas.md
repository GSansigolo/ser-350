...
### **Programação de Aulas 2026**

**LOCAL das AULAS:** Presenciais no LabGEO do INPE.

| Data | Tema da Aula | Professor | Material | Atividade |
| --- | --- | --- | --- | --- |
...
| **02/abr** | Introdução a Banco de Dados relacionais | Gilberto Queiroz |  |  |
| **07/abr** | Modelagem Numérica de Terreno | Carlos Felgueiras | Aula MNT |  |
...
| **05/mai** | Cubos de dados e análise de séries temporais | Karine Ferreira / Gabriel Sansigolo |  |  |
| **07/mai** | Introdução à Geoestatística I | Eduardo Camargo | Geoestatística |  |
| **12/mai** | Introdução à Geoestatística I | Eduardo Camargo |  |  |
| **14/mai** | Geoinformática aplicada a previsão de safras | Marcos Adami |  |  |
| **19/mai** | Geoinformática aplicada à Saúde | Ricardo Guimarães | [Google Meet](https://meet.google.com/rst-vkjb-yqv) |  |
| **26/mai** | Geoinformática no Monitoramento BiomasBR | Silvana Amaral |  |  |
| **28/mai** | Apresentação dos trabalhos dos alunos | Alunos |  |  |
